...
engine.execute("CREATE TABLE IF NOT EXISTS orders (ngay_number integer PRIMARY KEY, ky text, ngay text, so_hoa_don text, ma_mon text, ten_mon text, sl_ban integer, don_gia real, doanh_thu real)")
